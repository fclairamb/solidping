...
type CheckType = "http" | "tcp" | "icmp" | "dns" | "ssl" | "heartbeat" | "domain" | "smtp" | "udp" | "ssh" | "pop3" | "imap" | "websocket" | "postgresql" | "mysql" | "redis" | "mongodb" | "ftp" | "sftp" | "js" | "mssql" | "oracle" | "grpc" | "kafka";

function defaultPeriod(type: CheckType): string {
  if (type === "domain") return "24:00:00";
  return type === "dns" || type === "ssl" || type === "smtp" || type === "pop3" || type === "imap" || type === "websocket" || type === "postgresql" || type === "mysql" || type === "redis" || type === "mongodb" || type === "ftp" || type === "sftp" || type === "js" || type === "mssql" || type === "oracle" || type === "grpc" || type === "kafka" ? "01:00:00" : "00:01:00";
}
...
export function CheckForm({
  ...
  const currentConfig = useMemo(() => {
    ...
    serviceName, tls, brokers, topic, produceTest]);
