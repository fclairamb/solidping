...
- **Smart Incident Management** - Adaptive thresholds, cooldown, group-incident correlation, acknowledgment, and snooze
...
- **OAuth Authentication** - Sign in with Google, GitHub, GitLab, Microsoft, Slack, or Discord
