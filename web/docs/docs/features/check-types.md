...
`solidping.*`/`base64`/`console` API, and full tested examples (bearer-token
chaining, a cookie-jar login, Basic auth, cleanup workflows, sub-check
aggregation) are on their own page:**
