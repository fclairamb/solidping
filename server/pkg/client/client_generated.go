...
func (e AddMemberRequestRole) Valid() bool {
	...
	case AddMemberRequestRoleUser:
		return true
	case AddMemberRequestRoleViewer:
		return true
	default:
		return false
	}
...
func (e CreateDependencyRequestKind) Valid() bool {
	switch e {
...
func (e DependencyKind) Valid() bool {
	switch e {
	case DependencyKindHard:
		return true
	case DependencyKindSoft:
		return true
	default:
		return false
	}
...
func (e DiscoveryScanProgressDerivedStatus) Valid() bool {
	switch e {
	case DiscoveryScanProgressDerivedStatusFailed:
		return true
	case DiscoveryScanProgressDerivedStatusPending:
		return true
...
func (e ErrorCode) Valid() bool {
	switch e {
	case ErrorCodeCHECKHASACTIVEINCIDENTS:
		return true
	case ErrorCodeCHECKNOTFOUND:
		return true
	...
	case ErrorCodeINVALIDCREDENTIALS:
		return true
	case ErrorCodeINVALIDORG:
		return true
	case ErrorCodeINVALIDTOKEN:
		return true
	case ErrorCodeNOTFOUND:
		return true
	case ErrorCodeNOTOKEN:
		return true
	case ErrorCodeORGANIZATIONNOTFOUND:
		return true
...
func (e ExportedDependencyKind) Valid() bool {
	switch e {
	case ExportedDependencyKindHard:
		return true
	case ExportedDependencyKindSoft:
		return true
	default:
		return false
	}
...
func (e LoginResponseLoginAction) Valid() bool {
	switch e {
	case LoginResponseLoginActionEmpty:
		return true
	case LoginResponseLoginActionNoOrg:
		return true
	case LoginResponseLoginActionOrgChoice:
		return true
	case LoginResponseLoginActionOrgRedirect:
		return true
	default:
		return false
	}
...
func (e OrganizationMemberSummaryRole) Valid() bool {
	...
	case OrganizationMemberSummaryRoleUser:
		return true
	case OrganizationMemberSummaryRoleViewer:
		return true
	default:
		return false
	}
...
func (e UpdateDependencyRequestKind) Valid() bool {
	switch e {
...
func (e ListChecksParamsInternal) Valid() bool {
	switch e {
	case ListChecksParamsInternalAll:
		return true
	case ListChecksParamsInternalFalse:
		return true
	case ListChecksParamsInternalTrue:
		return true
	default:
		return false
	}
...
func (e GetBadgeParamsStyle) Valid() bool {
	switch e {
	case GetBadgeParamsStyleFlat:
		return true
	case GetBadgeParamsStyleFlatSquare:
		return true
	case GetBadgeParamsStylePlastic:
		return true
	default:
		return false
	}
...
func (e GetBadgeParamsFormat) Valid() bool {
	switch e {
	case GetBadgeParamsFormatResponseTime:
		return true
	case GetBadgeParamsFormatStatus:
		return true
	case GetBadgeParamsFormatUptime:
		return true
	default:
		return false
	}
...
func NewGetCostDistributionRequest(server string, params *GetCostDistributionParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.ThresholdMs != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "thresholdMs", *params.ThresholdMs, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "integer", Format: ""}); err != nil {
				return nil, err
			} else {
...
func NewRevokeTokenRequest(server string, tokenUid TokenUidPath) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "tokenUid", tokenUid, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: "uuid"})
	if err != nil {
		return nil, err
	}
...
func NewGetBadgeRequest(server string, org OrgPath, check string, format GetBadgeParamsFormat, params *GetBadgeParams) (*http.Request, error) {
	...
	pathParam2, err = runtime.StyleParamWithOptions("simple", false, "format", format, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewDismissDiscoveredGroupRequest(server string, org OrgPath, params *DismissDiscoveredGroupParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.JobUid != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "jobUid", *params.JobUid, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewListDiscoveredChecksRequest(server string, org OrgPath, params *ListDiscoveredChecksParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Promoted != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "promoted", *params.Promoted, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "boolean", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
...
func NewGetDiscoveryScanRequest(server string, org OrgPath, jobUid ScanJobUidPath) (*http.Request, error) {
	...
	pathParam1, err = runtime.StyleParamWithOptions("simple", false, "jobUid", jobUid, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "string", Format: "uuid"})
	if err != nil {
		return nil, err
	}
...
func NewListOrgResultsRequest(server string, org OrgPath, params *ListOrgResultsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.CheckType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "checkType", *params.CheckType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
		...
		if params.PeriodType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "periodType", *params.PeriodType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else {
				for _, qp := range strings.Split(queryFrag, "&") {
					rawQueryFragments = append(rawQueryFragments, qp)
