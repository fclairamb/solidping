...
func TestBuildResponseTimeSeries_GroupsAndSortsByRegion(t *testing.T) {
	...
	series := buildResponseTimeSeries(byRegion, models.DefaultAvailabilityThresholdUp, models.DefaultAvailabilityThresholdDegraded)
	...
	r.Nil(buildResponseTimeSeries(nil, models.DefaultAvailabilityThresholdUp, models.DefaultAvailabilityThresholdDegraded))
	r.Nil(buildResponseTimeSeries(map[string][]*models.Result{}, models.DefaultAvailabilityThresholdUp, models.DefaultAvailabilityThresholdDegraded))
	...
	r.Nil(buildResponseTimeSeries(markerOnly, models.DefaultAvailabilityThresholdUp, models.DefaultAvailabilityThresholdDegraded), "a signal-less region group must not produce a series")
	...
	mixedSeries := buildResponseTimeSeries(mixed, models.DefaultAvailabilityThresholdUp, models.DefaultAvailabilityThresholdDegraded)
	r.Len(mixedSeries, 1)
