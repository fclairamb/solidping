...
func (h *OIDCOAuthHandler) Login(writer http.ResponseWriter, req bunrouter.Request) error {
	...
	http.Redirect(writer, req.Request, authURL, http.StatusFound)
...
func (h *OIDCOAuthHandler) Callback(writer http.ResponseWriter, req bunrouter.Request) error {
