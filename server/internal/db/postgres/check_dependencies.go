...
// ListCheckDependenciesByOrg returns every active edge in the org, useful for
// the org-graph endpoint and the cycle-detection walk.
...
// FindActiveIncidentsForChecksInWindow returns the *active*, non-suppressed
// incidents whose check is one of the supplied UIDs and whose started_at falls
// inside [since, until]. Empty input yields nil.
