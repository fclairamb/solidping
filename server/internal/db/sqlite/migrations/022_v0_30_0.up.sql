-- v0.30.0 — the ONE consolidated SQLite migration for the (still unreleased)
...
-- SECTION, per wiki/conventions/database.md. Mirrors the Postgres twin
-- (022_v0_30_0) section for section.
--
