...
After evaluating Go-based screenshot tools (see [wiki/research/screenshot-tools.md](../../docs/research/screenshot-tools.md)), **Rod** (`github.com/go-rod/rod`) is the chosen library for the screenshot service:
